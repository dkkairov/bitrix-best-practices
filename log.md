...
- **2026-06-20 — standards: разработка коробки** — Оформлен свод стандартов разработки (edition=box):
  обзор [[d01-cn02-dev-standards]]; модули D03 (PT01 модульная разработка, RC01 структура+install,
  ...
  [[s-ss03-src-bxfw-course43-modules]] + raw. Обновлены 5 хабов и `index.md` (все представления).
