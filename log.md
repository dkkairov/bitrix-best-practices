...
- **2026-09-23 — ingest (продолжение): курс 43, глава «Отношения» и пропущенные уроки** — первый
  ...
  **Страница оставлена `draft`:** на стенде прогнать не удалось — Docker Desktop не запущен. Список
  из шести проверок — в конце страницы; после прогона снимаем черновик.
