...
- [[concept-d7-orm-relations|Связи ORM: Reference, OneToMany, ManyToMany]] · черновик
...
ORM разобрана по курсу 43 (2026-09-23): сущность, запись, выборка, объекты и коллекции, связи.
Страница связей пока `draft` — написана по курсу, но не прогнана на стенде.
