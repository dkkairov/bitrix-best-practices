...
ORM разобрана по курсу 43 (2026-09-23): сущность, запись, выборка, объекты и коллекции.
Не хватает: связи между сущностями (`ReferenceField`, N:M) и генерация аннотаций для IDE.
