...
Из раздела «Основы фреймворка» взяты роутинг, контроллеры и очереди сообщений; остальное этого
раздела (расширения, пре- и постфильтры, конфигурация ядра, cookie, хранилище, сессии) —
в очереди, вместе с пересверкой наших страниц про события, приложение и `Result`.
