...
related: ["[[d01-ap01-box-core-modification]]", "[[d03-rc01-module-structure-and-install]]"]
aliases: []
updated: "2026-06-20"
---
...
заказа и т.п.). Соблазн — поправить ядро; это антипаттерн [[d01-ap01-box-core-modification|Правка ядра]].
...
- **Распространяемая функциональность** → в модуле, при установке
  ([[d03-rc01-module-structure-and-install|InstallEvents]]):
  ```php
...
## Связанное
- [[d01-ap01-box-core-modification]], [[d03-rc01-module-structure-and-install]], [[d01-cn02-dev-standards|Стандарт разработки]]
