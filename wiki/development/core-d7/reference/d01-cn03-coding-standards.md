...
sources: []
related: ["[[d01-cn01-code-namespaces-and-autoloading]]", "[[d01-ap01-box-core-modification]]"]
aliases: []
updated: "2026-06-20"
---
...
## Стиль
- Пространства имён и автозагрузка — [[d01-cn01-code-namespaces-and-autoloading|по стандарту D7]];
...
## Чек-лист ревью
- [ ] Неймспейсы/автозагрузка по стандарту; нет правок ядра ([[d01-ap01-box-core-modification|почему]])
