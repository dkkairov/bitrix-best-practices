...
related: ["[[d03-rc01-module-structure-and-install]]", "[[d03-rc02-module-versioning-and-private-distribution]]", "[[d01-ap01-box-core-modification]]"]
aliases: []
updated: "2026-06-20"
---
...
- жизненный цикл `install`/`uninstall` (БД, события, агенты, права, опции) —
  [[d03-rc01-module-structure-and-install|Структура модуля и установка]];
- версионирование и распространение — [[d03-rc02-module-versioning-and-private-distribution|Версии и дистрибуция]];
- изоляцию (пространство имён `Vendor\Module`, без правки ядра — [[d01-ap01-box-core-modification|Правка ядра]]).
...
## Связанное
- [[d03-rc01-module-structure-and-install]], [[d03-rc02-module-versioning-and-private-distribution]]
