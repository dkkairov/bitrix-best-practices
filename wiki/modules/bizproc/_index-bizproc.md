...
антипаттерн переноса, своё действие с заданием и справочник по пяти классам движка.
Не хватает: каталога действий, рецептов типовых процессов (согласование, заявка), отладки, ошибок проектирования БП (ожидания без таймаута,
