...
- [[concept-bizproc-expressions|Выражения БП: вставка значения, функции, модификаторы, коды]]
...
- [[recipe-bizproc-approval-route|Маршрут согласования: срок, доработка в цикле, итог]]
- [[recipe-bizproc-request-intake|Заявка: уточнение, исполнитель, задача со сроком, контроль]]
- [[checklist-bizproc-template-review|Ревью шаблона БП: ошибки проектирования]]
- [[recipe-bizproc-debugging|Отладка БП: журнал, запись в отчёт, зависшие процессы]]

### Свои действия (коробка)
- [[recipe-bizproc-custom-activity-baseactivity|Своё действие на BaseActivity: форма, проверка, результат, ошибки]]
...
ревью шаблона и отладка; 2026-09-22 все страницы курса прогнаны на стенде в отдельном тестовом
смарт-процессе — по всем веткам, с исправлениями по итогам. Страницы разработки действий сверены с «Книгой разработчика»
...
Не хватает: сборки процессов со статусами в `tools/bpt`;
