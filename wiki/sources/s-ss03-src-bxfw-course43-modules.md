...
sources: []
related: ["[[d03-rc01-module-structure-and-install]]", "[[d03-pt01-module-based-development-standard]]", "[[d01-pt01-events-over-core-modification]]"]
aliases: []
updated: "2026-06-20"
---
...
## Что встроено в вики
- [[d03-rc01-module-structure-and-install|Структура модуля и установка]] — скелет `install/index.php`, `version.php`.
- [[d03-pt01-module-based-development-standard|Модульная разработка]] — когда модуль и где размещать.
- [[d01-pt01-events-over-core-modification|Расширение через события]] — регистрация обработчиков.

## Противоречия с текущими страницами
- Нет. Согласуется с [[d01-cn01-code-namespaces-and-autoloading|пространствами имён]] и
  антипаттерном [[d01-ap01-box-core-modification|правки ядра]].
