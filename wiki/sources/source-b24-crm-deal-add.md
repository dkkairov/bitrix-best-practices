...
sources: []
related: ["[[pattern-rest-webhooks-and-events]]", "[[pattern-crm-sales-funnel-design]]"]
...
- **Стадия и направление:** `STAGE_ID` задаётся в формате `C{категория}:{статус}` (например,
  ...
  [[pattern-crm-sales-funnel-design|Проектирование воронки]].
...
## Что встроено в вики
- [[pattern-rest-webhooks-and-events|Вебхуки и события]] — использован как пример дозапроса данных и вызова метода.
- [[pattern-crm-sales-funnel-design|Проектирование воронки]] — подтверждён формат `CATEGORY_ID` + `STAGE_ID`.
