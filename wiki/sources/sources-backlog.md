...
| 6 | [docs.1c-bitrix.ru — документация Bitrix Framework](https://docs.1c-bitrix.ru/) | каталог-указатель + содержание; **новый формат официальной документации**, куда 1С-Битрикс переносит курс 43 | [development/](../development/core-d7/_index-core-d7.md) | **P1** | по разделам: ORM (8 страниц), Основы фреймворка, База данных, Основы CMS, Расширенные знания, Безопасность, Производительность, UI, Модули. Начинать с разделов, которых в курсе нет или где он беднее |
